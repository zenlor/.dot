...
" Baseline
hi Normal           term=NONE              cterm=NONE              ctermfg=black ctermbg=253   gui=NONE              guifg=#000000 guibg=NONE

" Faded
hi ColorColumn      term=NONE              cterm=NONE              ctermfg=NONE  ctermbg=253   gui=NONE              guifg=NONE    guibg=#DADADA
hi Comment          term=NONE              cterm=NONE              ctermfg=248   ctermbg=NONE  gui=italic            guifg=#A8A8A8 guibg=NONE
...
hi SpecialComment   term=NONE              cterm=NONE              ctermfg=NONE  ctermbg=NONE  gui=italic,bold       guifg=NONE    guibg=NONE
...
function! NofrilsFocusComments()
    hi Comment   term=NONE cterm=NONE ctermfg=black ctermbg=NONE gui=italic guifg=#A8A8A8 guibg=NONE
    hi LineNr    term=NONE cterm=NONE ctermfg=248   ctermbg=bg   gui=NONE   guifg=#A8A8A8 guibg=NONE
    hi Character term=NONE cterm=NONE ctermfg=NONE  ctermbg=NONE gui=NONE   guifg=NONE    guibg=NONE
    hi String    term=NONE cterm=NONE ctermfg=NONE  ctermbg=NONE gui=NONE   guifg=NONE    guibg=NONE
