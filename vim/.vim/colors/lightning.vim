...
if ($TERM =~ '256' || &t_Co >= 256) || has('gui_running')
  hi Normal           ctermbg=231  ctermfg=234  guibg=#f1f1f1 guifg=#1c1c1c cterm=NONE           gui=NONE

  hi Comment          ctermbg=NONE ctermfg=244  guibg=NONE    guifg=#808080 cterm=italic         gui=italic
  ...
  hi LineNr           ctermbg=251  ctermfg=234  guibg=#dddddd guifg=#8c8c8c cterm=NONE           gui=NONE
  ...
  hi Pmenu            ctermbg=251  ctermfg=235  guibg=#dddddd guifg=#262626 cterm=NONE           gui=NONE
  ...
  hi FoldColumn       ctermbg=251  ctermfg=235  guibg=#dddddd guifg=#262626 cterm=NONE           gui=NONE
  hi Folded           ctermbg=251  ctermfg=235  guibg=#dddddd guifg=#262626 cterm=NONE           gui=NONE
  ...
  hi signColumn       ctermbg=251  ctermfg=235  guibg=#dddddd guifg=#262626 cterm=NONE           gui=NONE
...
if $NVIM_TUI_ENABLE_TRUE_COLOR == 1
  ...
  let g:terminal_background = "#F1F1F1"
