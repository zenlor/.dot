;;; doom-cosmic-latte-light-theme.el --- inspired by Atom One Dark
(require 'doom-themes)

;;
(defgroup doom-cosmic-latte-light-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom doom-cosmic-latte-light-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-cosmic-latte-light-theme
  :type 'boolean)

(defcustom doom-cosmic-latte-light-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-cosmic-latte-light-theme
  :type 'boolean)

(defcustom doom-cosmic-latte-light-comment-bg doom-cosmic-latte-light-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'doom-cosmic-latte-light-theme
  :type 'boolean)

(defcustom doom-cosmic-latte-light-padded-modeline doom-themes-padded-modeline
...
;;
(def-doom-theme doom-cosmic-latte-light
  ...
  ((bg         '("#FDF6E3" nil       nil            ))
   ...
   (selection      dark-blue)
   (builtin        magenta)
   (comments       (if doom-cosmic-latte-light-brighter-comments
   ...
   (-modeline-bright doom-cosmic-latte-light-brighter-modeline)
   (-modeline-pad
    (when doom-cosmic-latte-light-padded-modeline
      (if (integerp doom-cosmic-latte-light-padded-modeline) doom-cosmic-latte-light-padded-modeline 4)))
  ...
  ((elscreen-tab-other-screen-face :background "#353a42" :foreground "#1e2022")
   ...
   (font-lock-comment-face
    :slant 'italic
    :foreground comments
    :background (if doom-cosmic-latte-light-comment-bg (doom-blend teal base0 0.07)))
...
;;; doom-cosmic-latte-light-theme.el ends here
